...
%Use these for prediction
fprintf('Predictions made at original and new initial conditions\n')
...
v(1)=vobs(1);
[success,vobs,yobs] = getForward(vobs,yobs,k,m,c,nt,dt);
[success,v,y] = getForward(v,y,ki,mi,ci,nt,dt); %the guess
[Cost]=getCost(y,yobs,nt,0.,T);
fprintf('Guess cost=%15.10f\n',Cost)

[success,v,y] = getForward(v,y,knew,mnew,cnew,nt,dt); %the optimized
[Cost]=getCost(y,yobs,nt,0.,T);
fprintf('Optimized cost=%15.10f\n',Cost)
...
v(1)=vobs(1);
[success,vobs,yobs] = getForward(vobs,yobs,k,m,c,nt,dt);
[success,v,y] = getForward(v,y,knew,mnew,cnew,nt,dt);
[Cost]=getCost(y,yobs,nt,0.,T);
fprintf('1e-3 perturbation cost=%15.10f\n',Cost)
...
[success,v,y] = getForward(v,y,knew,mnew,cnew,nt,dt);
[Cost]=getCost(y,yobs,nt,0.,T);
fprintf('1e-2 perturbation cost=%15.10f\n',Cost)
...
[success,v,y] = getForward(v,y,knew,mnew,cnew,nt,dt);
[Cost]=getCost(y,yobs,nt,0.,T);
fprintf('1e-1 perturbation cost=%15.10f\n',Cost)
...
fprintf('Completed the optimizer\n')
end
